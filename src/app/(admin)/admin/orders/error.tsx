  ...
  return (
    <main className="px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-3xl border border-destructive/30 bg-destructive/5 p-8 text-center">
        <p className="text-xl font-semibold text-foreground">Unable to load orders</p>
        <p className="mt-2 text-sm text-muted-foreground">Please try again. If the problem persists, check server logs.</p>
        <button
          type="button"
          onClick={reset}
